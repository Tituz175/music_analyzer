# Code taken from: https://github.com/jackmcarthur/musical-key-finder/blob/master/keyfinder.py
# Data: 10/14/2023
# Changelog
# - print_key() reformat and change to get_key()
# - chromagram, coor_table and print_chroma methods removed
